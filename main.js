...
var author$project$Modal$Closed = {$: 'Closed'};
var author$project$Modal$initModel = author$project$Modal$Closed;
var elm$core$Maybe$Nothing = {$: 'Nothing'};
var author$project$Main$initModel = {modal: author$project$Modal$initModel, status: elm$core$Maybe$Nothing};
var author$project$Modal$Opening = function (a) {
	return {$: 'Opening', a: a};
};
var author$project$Modal$GetWindowSize = F2(
	function (a, b) {
		return {$: 'GetWindowSize', a: a, b: b};
	});
...
var author$project$Modal$Opened = function (a) {
	return {$: 'Opened', a: a};
};
var author$project$Modal$BodySettings = function (a) {
	return {$: 'BodySettings', a: a};
};
var elm$core$Basics$ge = _Utils_ge;
var iodevs$elm_history$History$current = function (_n0) {
	var cur = _n0.a;
	return cur;
};
...
var iodevs$elm_history$History$rewindAll = function (history) {
	var past = history.b;
	var _n0 = elm$core$List$reverse(past);
	if (_n0.b) {
		var old = _n0.a;
		var remains = _n0.b;
		return A2(iodevs$elm_history$History$History, old, _List_Nil);
	} else {
		return history;
	}
};
...
var author$project$Modal$setBodySettings = F2(
	function (updateFn, _n0) {
		var c = _n0.a;
...
var author$project$Modal$setModalState = function (modal) {
	switch (modal.$) {
		case 'Opening':
			var config = modal.a;
			return author$project$Modal$Opened(config);
		case 'Opened':
			var config = modal.a;
			return author$project$Modal$Closing(config);
		case 'Closing':
			return author$project$Modal$Closed;
		default:
			return author$project$Modal$Closed;
		...
		switch (msg.$) {
			case 'OpenModal':
				...
				return _Utils_Tuple2(
					author$project$Modal$Opening(config),
					author$project$Modal$cmdGetWindowSize);
			case 'CloseModal':
				return _Utils_Tuple2(
					author$project$Modal$setModalState(model),
			...
			default:
				...
				var height = msg.b;
				return _Utils_Tuple2(
					A3(author$project$Modal$setModalBodyPosition, width, height, model),
					elm$core$Platform$Cmd$none);
		}
	});
...
var author$project$Main$update = F2(
	function (msg, model) {
		switch (msg.$) {
			case 'ModalMsg':
				var modalMsg = msg.a;
				var _n1 = A2(author$project$Modal$update, modalMsg, model.modal);
				var updatedModal = _n1.a;
				var cmdModal = _n1.b;
				return _Utils_Tuple2(
					_Utils_update(
						model,
						{modal: updatedModal}),
					A2(elm$core$Platform$Cmd$map, author$project$Main$ModalMsg, cmdModal));
			case 'Approve':
...
var author$project$Main$bodyAlert = A2(
	elm$html$Html$div,
	_List_Nil,
	_List_fromArray(
		[
			elm$html$Html$text('Run and make panic...')
		]));
...
var author$project$Main$footerSuccess = F2(
	function (confirmMsg, closeMsg) {
		return A2(
			elm$html$Html$div,
			_List_fromArray(
				[
...
var author$project$Modal$FromBottom = {$: 'FromBottom'};
var author$project$Modal$OpenFromBottom = {$: 'OpenFromBottom'};
var author$project$Modal$ToBottom = {$: 'ToBottom'};
var author$project$Modal$CloseModal = {$: 'CloseModal'};
var author$project$Modal$closeModal = function (fn) {
	return fn(author$project$Modal$CloseModal);
};
var author$project$Modal$FromTop = {$: 'FromTop'};
var author$project$Modal$OpenFromTop = {$: 'OpenFromTop'};
var author$project$Modal$ToTop = {$: 'ToTop'};
var author$project$Modal$WithAnimate = {$: 'WithAnimate'};
var iodevs$elm_history$History$create = function (value) {
	return A2(iodevs$elm_history$History$History, value, _List_Nil);
};
...
var author$project$Modal$newConfig = function (tagger) {
	return author$project$Modal$Config(
		{
			body: rtfeldman$elm_css$Html$Styled$text(''),
			bodyCss: '',
			closingAnimation: author$project$Modal$ToTop,
			closingEffect: author$project$Modal$WithAnimate,
			footer: rtfeldman$elm_css$Html$Styled$text(''),
			footerCss: '',
			header: rtfeldman$elm_css$Html$Styled$text(''),
			headerCss: '',
...
var author$project$Modal$setClosingAnimation = F2(
	function (closing, config) {
		var fn = function (_n0) {
			var c = _n0.a;
			return author$project$Modal$Config(
				_Utils_update(
...
var author$project$Modal$setFooter = F2(
	function (newFooter, config) {
		var fn = function (_n0) {
			var c = _n0.a;
			return author$project$Modal$Config(
				_Utils_update(
...
var author$project$Modal$setHeader = F2(
		...
		var fn = function (_n0) {
			...
			return author$project$Modal$Config(
				_Utils_update(
					c,
					{
						header: rtfeldman$elm_css$Html$Styled$fromUnstyled(newHeader)
					}));
		};
		return A2(author$project$Modal$mapConfig, fn, config);
	});
var author$project$Modal$setHeaderCss = F2(
	function (newHeaderCss, config) {
		var fn = function (_n0) {
			var c = _n0.a;
			return author$project$Modal$Config(
				_Utils_update(
					c,
					{headerCss: newHeaderCss}));
		};
		return A2(author$project$Modal$mapConfig, fn, config);
	});
var author$project$Modal$setOpenedAnimation = F2(
...
var author$project$Modal$setOpeningAnimation = F2(
...
var author$project$Main$configAlert = A2(
	author$project$Modal$setFooter,
	A2(
		author$project$Main$footerSuccess,
...
var author$project$Main$bodyInfo = A2(
	...
	_List_fromArray(
		[
			elm$html$Html$text('Everything is fine.')
		]));
var author$project$Modal$FromRight = {$: 'FromRight'};
var author$project$Modal$OpenFromRight = {$: 'OpenFromRight'};
var author$project$Modal$ToRight = {$: 'ToRight'};
var author$project$Main$configInfo = A2(
	author$project$Modal$setFooter,
	A2(
		author$project$Main$footerSuccess,
		author$project$Modal$closeModal(author$project$Main$ModalMsg),
...
var author$project$Main$bodySuccess = function (approveMsg) {
	return A2(
		elm$html$Html$div,
		_List_fromArray(
			[
				elm$html$Html$Attributes$class('callout clearfix'),
		...
		_List_fromArray(
			[
				...
				_List_fromArray(
					[
						elm$html$Html$text('Elm is great.')
					])),
				A2(
				elm$html$Html$div,
				_List_fromArray(
				...
				_List_fromArray(
					[
						...
						_List_fromArray(
							[
								elm$html$Html$Attributes$class('hollow button success'),
								elm$html$Html$Events$onClick(approveMsg)
							]),
						_List_fromArray(
							[
...
var author$project$Main$bodyWarning = A2(
	...
	_List_fromArray(
		[
			elm$html$Html$text('Don\'t be worry. It\'s just warning...')
		]));
var author$project$Main$footerWarning = function (msg) {
	return A2(
		elm$html$Html$button,
		_List_fromArray(
			[
...
var author$project$Modal$WithoutAnimate = {$: 'WithoutAnimate'};
var author$project$Modal$setClosingEffect = F2(
	function (newClosingEffect, config) {
		var fn = function (_n0) {
			var c = _n0.a;
			return author$project$Modal$Config(
				_Utils_update(
					c,
					{closingEffect: newClosingEffect}));
		};
		return A2(author$project$Modal$mapConfig, fn, config);
	});
var author$project$Main$configWarning = A2(
	author$project$Modal$setFooter,
...
var author$project$Modal$openModal = F2(
	function (fn, config) {
		return fn(
			author$project$Modal$OpenModal(config));
	});
var author$project$Modal$AnimationEnd = {$: 'AnimationEnd'};
...
var author$project$Modal$modalBottomClosing = function (_n0) {
	var body = _n0.a;
	return rtfeldman$elm_css$Html$Styled$Attributes$css(
		_List_fromArray(
			[
						...
						[
							...
							_List_fromArray(
								[
									...
									A2(rtfeldman$elm_css$Css$Animations$property, 'top', body.fromTop.value)
								])),
							_Utils_Tuple2(
							100,
							_List_fromArray(
				...
				A2(rtfeldman$elm_css$Css$property, 'left', body.center.value)
			]));
};
var rtfeldman$elm_css$Css$left = rtfeldman$elm_css$Css$prop1('left');
var rtfeldman$elm_css$Css$top = rtfeldman$elm_css$Css$prop1('top');
var author$project$Modal$modalLeftClosing = function (_n0) {
	var body = _n0.a;
	return rtfeldman$elm_css$Html$Styled$Attributes$css(
		_List_fromArray(
			[
					...
					_List_fromArray(
						[
							...
							_List_fromArray(
								[
									A2(rtfeldman$elm_css$Css$Animations$property, 'opacity', '0'),
									A2(rtfeldman$elm_css$Css$Animations$property, 'left', '0'),
									A2(rtfeldman$elm_css$Css$Animations$property, 'top', body.fromTop.value)
								]))
						]))),
				A2(rtfeldman$elm_css$Css$property, 'animation-duration', '0.5s'),
				...
				rtfeldman$elm_css$Css$top(body.fromTop)
			]));
};
var rtfeldman$elm_css$Css$right = rtfeldman$elm_css$Css$prop1('right');
var author$project$Modal$modalRightClosing = function (_n0) {
	var body = _n0.a;
	return rtfeldman$elm_css$Html$Styled$Attributes$css(
		_List_fromArray(
			[
					...
					_List_fromArray(
						[
							...
							_List_fromArray(
								[
									A2(rtfeldman$elm_css$Css$Animations$property, 'opacity', '1'),
									A2(rtfeldman$elm_css$Css$Animations$property, 'right', body.center.value),
									A2(rtfeldman$elm_css$Css$Animations$property, 'top', body.fromTop.value)
								])),
							_Utils_Tuple2(
							100,
							_List_fromArray(
								[
									A2(rtfeldman$elm_css$Css$Animations$property, 'opacity', '0'),
									A2(rtfeldman$elm_css$Css$Animations$property, 'right', '0'),
									A2(rtfeldman$elm_css$Css$Animations$property, 'top', body.fromTop.value)
								]))
						]))),
				A2(rtfeldman$elm_css$Css$property, 'animation-duration', '0.5s'),
...
var author$project$Modal$modalTopClosing = function (_n0) {
	var body = _n0.a;
	return rtfeldman$elm_css$Html$Styled$Attributes$css(
		_List_fromArray(
			[
						...
						[
							...
							_List_fromArray(
								[
									A2(rtfeldman$elm_css$Css$Animations$property, 'opacity', '0'),
									A2(rtfeldman$elm_css$Css$Animations$property, 'left', body.center.value),
									A2(rtfeldman$elm_css$Css$Animations$property, 'top', '20px')
								]))
						]))),
				A2(rtfeldman$elm_css$Css$property, 'animation-duration', '0.5s'),
				rtfeldman$elm_css$Css$opacity(
...
var author$project$Modal$closingAnimationClass = F2(
	function (animation, bodySettings) {
		switch (animation.$) {
			case 'ToTop':
				return author$project$Modal$modalTopClosing(bodySettings);
			case 'ToRight':
				return author$project$Modal$modalRightClosing(bodySettings);
			case 'ToBottom':
				return author$project$Modal$modalBottomClosing(bodySettings);
			default:
				return author$project$Modal$modalLeftClosing(bodySettings);
		}
	});
...
var author$project$Modal$closingEffectClass = function (animation) {
	if (animation.$ === 'WithoutAnimate') {
		return rtfeldman$elm_css$Html$Styled$Attributes$css(
			_List_fromArray(
				[
...
var author$project$Modal$modalBody = function (_n0) {
	var body = _n0.a;
	return rtfeldman$elm_css$Html$Styled$Attributes$css(
		_List_fromArray(
			[
...
var author$project$Modal$onAnimationEnd = function (msg) {
	return A2(
...
var author$project$Modal$modalBodyView = F3(
	function (animationTagger, animation, _n0) {
		var config = _n0.a;
		var animTgr = function () {
			if (animationTagger.$ === 'Just') {
				var msg = animationTagger.a;
				return author$project$Modal$onAnimationEnd(
					config.tagger(msg));
			} else {
				return rtfeldman$elm_css$Html$Styled$Attributes$css(_List_Nil);
			}
		...
		return A2(
			...
			_List_fromArray(
				[
					author$project$Modal$modalBody(config.modalBodySettings),
					animation,
					animTgr
				]),
			_List_fromArray(
...
var author$project$Modal$modalClose = rtfeldman$elm_css$Html$Styled$Attributes$css(
	_List_fromArray(
		[
			rtfeldman$elm_css$Css$animationName(
			rtfeldman$elm_css$Css$Animations$keyframes(
				_List_fromArray(
					[
						...
						_List_fromArray(
							[
								A2(rtfeldman$elm_css$Css$Animations$property, 'background', 'rgba(0, 0, 0, 0.5)')
							])),
						_Utils_Tuple2(
						100,
						_List_fromArray(
							[
								A2(rtfeldman$elm_css$Css$Animations$property, 'background', 'rgba(0, 0, 0, 0)'),
								A2(rtfeldman$elm_css$Css$Animations$property, 'display', 'none')
							]))
					]))),
			A2(rtfeldman$elm_css$Css$property, 'animation-duration', '0.5s'),
			rtfeldman$elm_css$Css$backgroundColor(
...
var author$project$Modal$modalFade = rtfeldman$elm_css$Html$Styled$Attributes$css(
	_List_fromArray(
		[
			rtfeldman$elm_css$Css$position(rtfeldman$elm_css$Css$absolute),
			rtfeldman$elm_css$Css$top(
...
var author$project$Modal$modalOpenFromBottom = function (_n0) {
	var body = _n0.a;
	return rtfeldman$elm_css$Html$Styled$Attributes$css(
		_List_fromArray(
			[
...
var author$project$Modal$modalOpenFromLeft = function (_n0) {
	var body = _n0.a;
	return rtfeldman$elm_css$Html$Styled$Attributes$css(
		_List_fromArray(
			[
...
var author$project$Modal$modalOpenFromRigth = function (_n0) {
	var body = _n0.a;
	return rtfeldman$elm_css$Html$Styled$Attributes$css(
		_List_fromArray(
			[
				A2(rtfeldman$elm_css$Css$property, 'right', body.center.value),
				rtfeldman$elm_css$Css$top(body.fromTop),
				rtfeldman$elm_css$Css$position(rtfeldman$elm_css$Css$absolute)
			]));
};
var author$project$Modal$modalOpenFromTop = function (_n0) {
	var body = _n0.a;
	return rtfeldman$elm_css$Html$Styled$Attributes$css(
		_List_fromArray(
			[
...
var author$project$Modal$openedAnimationClass = F2(
	function (animation, bodySettings) {
		switch (animation.$) {
			case 'OpenFromTop':
				return author$project$Modal$modalOpenFromTop(bodySettings);
			case 'OpenFromRight':
				return author$project$Modal$modalOpenFromRigth(bodySettings);
			case 'OpenFromBottom':
				return author$project$Modal$modalOpenFromBottom(bodySettings);
			default:
				return author$project$Modal$modalOpenFromLeft(bodySettings);
		}
	});
var author$project$Modal$modalBottomOpening = function (_n0) {
	var body = _n0.a;
	return rtfeldman$elm_css$Html$Styled$Attributes$css(
		_List_fromArray(
			[
						...
						[
							...
							_List_fromArray(
								[
									A2(rtfeldman$elm_css$Css$Animations$property, 'opacity', '0'),
									A2(rtfeldman$elm_css$Css$Animations$property, 'left', body.center.value),
									A2(rtfeldman$elm_css$Css$Animations$property, 'top', '75%')
								])),
							_Utils_Tuple2(
							75,
							_List_fromArray(
...
var author$project$Modal$modalLeftOpening = function (_n0) {
	var body = _n0.a;
	return rtfeldman$elm_css$Html$Styled$Attributes$css(
		_List_fromArray(
			[
...
var author$project$Modal$modalRigthOpening = function (_n0) {
	var body = _n0.a;
	return rtfeldman$elm_css$Html$Styled$Attributes$css(
		_List_fromArray(
			[
...
var author$project$Modal$modalTopOpening = function (_n0) {
	var body = _n0.a;
	return rtfeldman$elm_css$Html$Styled$Attributes$css(
		_List_fromArray(
			[
						...
						[
							...
							_List_fromArray(
								[
									A2(rtfeldman$elm_css$Css$Animations$property, 'opacity', '0'),
									A2(rtfeldman$elm_css$Css$Animations$property, 'left', body.center.value),
									A2(rtfeldman$elm_css$Css$Animations$property, 'top', '0')
								])),
							_Utils_Tuple2(
							75,
							_List_fromArray(
...
var author$project$Modal$openingAnimationClass = F2(
	function (animation, bodySettings) {
		switch (animation.$) {
			case 'FromTop':
				return author$project$Modal$modalTopOpening(bodySettings);
			case 'FromRight':
				return author$project$Modal$modalRigthOpening(bodySettings);
			case 'FromBottom':
				return author$project$Modal$modalBottomOpening(bodySettings);
			default:
				return author$project$Modal$modalLeftOpening(bodySettings);
		}
	});
...
var author$project$Modal$view = function (modal) {
	return rtfeldman$elm_css$Html$Styled$toUnstyled(
		function () {
			switch (modal.$) {
				case 'Opening':
					var config = modal.a.a;
					return A2(
						rtfeldman$elm_css$Html$Styled$div,
						_List_fromArray(
							[author$project$Modal$modalFade]),
						_List_fromArray(
							[
								A3(
								author$project$Modal$modalBodyView,
								elm$core$Maybe$Just(author$project$Modal$AnimationEnd),
								A2(author$project$Modal$openingAnimationClass, config.openingAnimation, config.modalBodySettings),
								author$project$Modal$Config(config))
							]));
				case 'Opened':
					var config = modal.a.a;
					return A2(
						...
						_List_fromArray(
							[
								...
								author$project$Modal$modalBodyView,
								elm$core$Maybe$Nothing,
								A2(author$project$Modal$openedAnimationClass, config.openedAnimation, config.modalBodySettings),
								author$project$Modal$Config(config))
							]));
				case 'Closing':
					var config = modal.a.a;
					return A2(
						...
						_List_fromArray(
							[
								author$project$Modal$modalFade,
								author$project$Modal$modalClose,
								author$project$Modal$closingEffectClass(config.closingEffect)
							]),
						_List_fromArray(
							[
								A3(
								author$project$Modal$modalBodyView,
								elm$core$Maybe$Just(author$project$Modal$AnimationEnd),
								A2(author$project$Modal$closingAnimationClass, config.closingAnimation, config.modalBodySettings),
								author$project$Modal$Config(config))
							]));
				default:
	...
	return A2(
		...
		_List_fromArray(
			[
					...
					[
						...
						_List_fromArray(
							[
								...
								_List_fromArray(
									[
										elm$html$Html$Attributes$class('info__header')
									]),
								_List_fromArray(
									[
										elm$html$Html$text('Modal window')
									])),
								A2(
								elm$html$Html$div,
								_List_fromArray(
					...
					[
						...
						_List_fromArray(
							[
								...
								_List_fromArray(
									[
										elm$html$Html$Attributes$class('button btn--width'),
										elm$html$Html$Events$onClick(
										A2(author$project$Modal$openModal, author$project$Main$ModalMsg, author$project$Main$configSuccess))
									]),
								_List_fromArray(
									[
										elm$html$Html$text('Modal Success')
									]))
							])),
						A2(
						elm$html$Html$div,
							...
							[
								...
								_List_fromArray(
									[
										elm$html$Html$Attributes$class('button btn--width'),
										elm$html$Html$Events$onClick(
										A2(author$project$Modal$openModal, author$project$Main$ModalMsg, author$project$Main$configWarning))
									]),
								_List_fromArray(
									[
										elm$html$Html$text('Modal Warning')
									]))
							])),
						A2(
						elm$html$Html$div,
							...
							[
								...
								_List_fromArray(
									[
										elm$html$Html$Attributes$class('button btn--width'),
										elm$html$Html$Events$onClick(
										A2(author$project$Modal$openModal, author$project$Main$ModalMsg, author$project$Main$configAlert))
									]),
								_List_fromArray(
									[
										elm$html$Html$text('Modal Alert')
									]))
							])),
						A2(
						elm$html$Html$div,
							...
							[
								...
								_List_fromArray(
									[
										elm$html$Html$Attributes$class('button btn--width'),
										elm$html$Html$Events$onClick(
										A2(author$project$Modal$openModal, author$project$Main$ModalMsg, author$project$Main$configInfo))
									]),
								_List_fromArray(
									[
										elm$html$Html$text('Modal Info')
									]))
							]))
					])),
				A2(
							...
							[
								...
								_List_fromArray(
									[
										...
										elm$html$Html$Events$onClick(
										A2(
											author$project$Modal$openModal,
											author$project$Main$ModalMsg,
											A2(
												author$project$Modal$setClosingAnimation,
												author$project$Modal$ToRight,
												A2(author$project$Modal$setOpeningAnimation, author$project$Modal$FromLeft, author$project$Main$configSuccess))))
									]),
								_List_fromArray(
									[
										A2(
										...
										_List_fromArray(
											[
												elm$html$Html$Attributes$class('fi-arrow-right icon--margin')
											]),
										_List_Nil),
										A2(
										elm$html$Html$i,
							...
							[
								...
								_List_fromArray(
									[
										...
										_List_fromArray(
											[
												elm$html$Html$Attributes$class('fi-arrow-down icon--margin')
											]),
										_List_Nil)
									]))
							])),
									...
									[
										...
										A2(
											...
											A2(
												author$project$Modal$setClosingAnimation,
												author$project$Modal$ToBottom,
												A2(author$project$Modal$setOpeningAnimation, author$project$Modal$FromTop, author$project$Main$configSuccess))))
									]),
								_List_fromArray(
									[
										A2(
								...
								_List_fromArray(
									[
										...
										A2(
											...
											A2(
												author$project$Modal$setClosingAnimation,
												author$project$Modal$ToLeft,
												A2(author$project$Modal$setOpeningAnimation, author$project$Modal$FromRight, author$project$Main$configSuccess))))
									]),
								_List_fromArray(
									[
										A2(
										...
										_List_fromArray(
											[
												elm$html$Html$Attributes$class('fi-arrow-left icon--margin')
											]),
										_List_Nil),
										A2(
										elm$html$Html$i,
				...
				author$project$Modal$view(model.modal)
			]));
};
		...
		init: elm$core$Basics$always(
			_Utils_Tuple2(
				...
				elm$core$Platform$Cmd$batch(
					_List_fromArray(
						[
							A2(elm$core$Platform$Cmd$map, author$project$Main$ModalMsg, author$project$Modal$cmdGetWindowSize)
						])))),
		subscriptions: function (model) {
			return elm$core$Platform$Sub$batch(
				_List_fromArray(
					[
						A2(elm$core$Platform$Sub$map, author$project$Main$ModalMsg, author$project$Modal$subscriptions)
					]));
		},
